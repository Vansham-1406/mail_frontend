...
const Deleted = () => {
  ...
  const api = () => {
    if (dt === false && items.username === undefined) {} 
      ...
      axios
        .get(`https://mail-backend-ytfz.onrender.com/message/getData`, {
                            ...
                            <TableRow key={item?.id}>
                              <TableCell
                                ...
                                onClick={() => {
                                  axios
                                    .put(
                                      `https://mail-backend-ytfz.onrender.com/message/checkOpened`,
                                      item
                                    )
                                    .then((response) => {
                                      api();
                              ...
                              <TableCell align="right">
                                {
                                  <DeleteIcon
                                    ...
                                    onClick={() => {
                                      ...
                                      if(f)
                                      {
                                        axios.delete(`https://mail-backend-ytfz.onrender.com/message/removeMess?id=${item._id}`)
                                        .then((response)=>{api()})
